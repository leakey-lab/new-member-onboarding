...
2. Once these questions are answered, appropriate storage locations can be decided.
    ...
    - If collaboration within the lab is necessary, one of the shared data resources should be used. Embed your directory under the grant/project that you'll be working on.
